...
import com.example.cropimagelayout.R
import com.example.cropimagelayout.cropLayout.internal.GestureAnimation
import com.example.cropimageshape.cropLayout.internal.GestureAnimator
...
class CropLayout @JvmOverloads constructor(
        ...
        try {
            ...
            val defaultCropOverlay: CropOverlay = when (overlayShape) {
                ...
                OVERLAY_SHAPE_CUSTOM -> {
                    val layoutId =
                        a.getResourceId(R.styleable.CropLayout_cropme_custom_shape_layout, -1)
            ...
            defaultCropOverlay.layoutParams =
                LayoutParams(MATCH_PARENT, MATCH_PARENT, Gravity.CENTER)
    ...
    companion object {
        ...
        @IntDef(OVERLAY_SHAPE_NONE,
                OVERLAY_SHAPE_RECTANGLE,
